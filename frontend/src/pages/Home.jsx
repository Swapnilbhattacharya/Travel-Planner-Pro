...
const Home = () => {
  ...
  return (
    // Merged: Added pb-20 for scroll clearance AND Dark Mode background transitions
    <div className="w-full pb-20 bg-white dark:bg-gray-950 transition-colors duration-500">
      ...
      <div className="relative h-[400px] md:h-[500px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-5xl px-6 mt-10">
          ...
          {/* THE SEARCH BOX (Dark Mode Ready) */}
      ...
      <div className="max-w-7xl mx-auto pt-20 px-6">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4">
          ...
          {/* Enhanced Filter Buttons (Dark Mode Ready) */}
              ...
              <button 
                ...
                className={`px-5 py-2 rounded-full font-bold text-sm transition-all whitespace-nowrap ${
                  filter === type 
                    ...
                    : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-slate-400 dark:hover:border-gray-500'
                }`}
              >
                {type}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredData.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20 text-slate-500 dark:text-gray-400 font-bold">
              No destinations found for this filter.
            </div>
          )}
        </div>

        {/* 4. THE INVISIBLE TRIGGER BOX (Dark Mode Ready) */}
        <div ref={observerTarget} className="w-full flex justify-center py-10 mt-8">
          {isLoading && filteredData.length > 0 && (
            <div className="flex items-center gap-3 text-blue-600 dark:text-blue-400 font-bold bg-blue-50 dark:bg-blue-900/30 px-6 py-3 rounded-full shadow-sm transition-colors">
